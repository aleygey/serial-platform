          ...
          return (
            ...
            >
              ...
              <span className="port-copy">
                <strong>{port}</strong>
                <small className={configured?.config.model_name ? 'model-identity' : undefined} title={configured?.config.model_name || undefined}>{configured?.config.model_name || descriptor?.product || '未配置机型'}</small>
              </span>
